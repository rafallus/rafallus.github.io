...
setup() {
    ...
    var prs = reactive({ content: [], error: ""});
    var prsList = [];
    var longList = false;
    ...
    function addPR(info) {
        ...
        prsList.push(pr);
        let end = Math.min(prsList.length, longList ? MAX_PR_SHOWN : INIT_PR_SHOWN);
    ...
    onMounted(() => {
        ...
        let repo = "godot";
        let prIdList = [54647, 54560, 54533, 54471, 54456, 53893, 48377, 48376, 47814, 47485, 47484, 47470];
